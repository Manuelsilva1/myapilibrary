...
public class CarritoController {
    ...
    @PostMapping("/items")
    public ResponseEntity<?> agregarItemAlCarrito(Authentication authentication, @Validated @RequestBody ItemCarritoDTO itemDTO) {
        UUID usuarioId = getCurrentUsuarioId(authentication);
        try {
    ...
    public ResponseEntity<?> actualizarCantidadItem(Authentication authentication, @PathVariable UUID itemId, @Validated @RequestBody ItemCarritoDTO itemUpdateDTO) {
