...
public class EditorialController {
    ...
    public ResponseEntity<Editorial> createEditorial(@Validated @RequestBody Editorial editorial) {
    ...
    @PutMapping("/{id}")
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<Editorial> updateEditorial(@PathVariable UUID id, @Validated @RequestBody Editorial editorialDetails) {
